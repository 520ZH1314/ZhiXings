...
public class GregorianLunarCalendarOneView extends LinearLayout implements NumberPickerView.OnValueChangeListener{
    ...
    public GregorianLunarCalendarOneView(Context context) {
        super(context);
        initInternal(context);
    }

    public GregorianLunarCalendarOneView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttr(context, attrs);
        initInternal(context);
    }

    public GregorianLunarCalendarOneView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initInternal(Context context){
        View contentView = inflate(context, R.layout.view_gregorian_lunar_one_calendar, this);

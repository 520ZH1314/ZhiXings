...
public class TaskActivity extends BaseActvity implements View.OnClickListener{
    ...
    private void initData(String status) {
        ...
        params.put("TenantId", SharedPreferencesTool.getMStool(TaskActivity.this).getTenantId());
        ...
        try {
            ...
            myData.put("TenantId", SharedPreferencesTool.getMStool(TaskActivity.this).getTenantId());
        ...
        JsonObjectRequest newMissRequest = new JsonObjectRequest(
                Request.Method.POST, SharedPreferencesTool.getMStool(TaskActivity.this).getIp()+ UrlUtil.Url,
            ...
            public void onResponse(JSONObject jsonobj) {
                ...
                try {
                    ...
                    GroupTaskAdapter adapter=new GroupTaskAdapter(TaskActivity.this,list_data);
    ...
    private void initView() {
        ...
        for (int i = 0; i < titleList.size(); i++) {
            ...
            int w = SysUtils.getScreenWidth(TaskActivity.this) / 3;
            ...
            myRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(RadioGroup group, int checkedId) {
                    ...
                    int width=(int) SizeHelper.dp2px(TaskActivity.this, 150);

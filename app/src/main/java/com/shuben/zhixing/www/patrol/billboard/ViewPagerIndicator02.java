...
public class ViewPagerIndicator02 extends LinearLayout
{
    /**
     * 绘制三角形的画笔
     */
    ...
    public ViewPagerIndicator02(Context context)
    {
        this(context, null);
    }

    public ViewPagerIndicator02(Context context, AttributeSet attrs)
    {
        super(context, attrs);

        // 获得自定义属性，tab的数量
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.ViewPagerIndicator01);
        mTabVisibleCount = a.getInt(R.styleable.ViewPagerIndicator01_item_count,
                COUNT_DEFAULT_TAB);
    ...
    // 对外的ViewPager的回调接口
    private ViewPagerIndicator02.PageChangeListener onPageChangeListener;

    // 对外的ViewPager的回调接口的设置
    public void setOnPageChangeListener(ViewPagerIndicator02.PageChangeListener pageChangeListener)
    {

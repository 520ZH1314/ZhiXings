...
/**
 * Created by Geyan on 2018/3/24.
 */

public class AnanlysisAdapter extends BaseAdapter {
    private Context mContext;
    private LayoutInflater inflater;
    private List<SceneInfo> mlist;
    private SceneInfo info;
    public AnanlysisAdapter(Context mContext, List<SceneInfo> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.listview_analysis_item, null);

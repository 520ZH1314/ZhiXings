...
public  class NoticeAdapter extends BaseAdapter {
    ...
    public NoticeAdapter(Activity activity, List<NotificationData> news) {
        datas = news;
        mContext =activity;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.activity_notification_item2, null);
        ...
        holder.renwu_context.setText("任务内容："+datas.get(position).getTitle());//任务
        ...
        if (datas.get(position).getCreateDate().length()>10){
            ...
            holder.time_tv.setText(datas.get(position).getCreateDate().substring(11,19));//创建时间
        }else {
   ...
   class ViewHolder
   {
    public TextView renwu_context,bianhao_tv,source_tv,stop_time_tv,fabu_name,crate_time_tv,time_tv;
  }
}

...
public class BarChartView {  
    ...
    private static int[] colors = new int[] { Color.rgb(95, 174, 227), Color.GREEN };  
    ...
    public View getBarChartView(int w,double h,int weigh) {  
        buildBarRenderer(weigh/(2*w-1));  
        setChartSettings(renderer, mTitle, "", "", 0, w, 0, 100, Color.BLACK, Color.LTGRAY);  
        ...
        renderer.setZoomEnabled(false, true);// 设置x，y方向都不可以放大或缩�?  
    ...
    protected void setChartSettings(XYMultipleSeriesRenderer renderer, String title, String xTitle, String yTitle,  
        ...
        renderer.setShowGrid(false);//设置是否显示网格

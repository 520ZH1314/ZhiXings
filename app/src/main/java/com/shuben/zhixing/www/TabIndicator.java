...
public class TabIndicator extends LinearLayout implements View.OnClickListener {
  ...
  private SharedPreferencesTool mStool;
    ...
    private int[] tabImageId = {R.mipmap.tab_home,R.mipmap.tab_task,R.mipmap.tab_group,R.mipmap.tab_set};
    private int[] tabImageSelectedId ={R.mipmap.tab_homeclick,R.mipmap.tab_taskclick,R.mipmap.tab_groupclick,R.mipmap.tab_setclick};

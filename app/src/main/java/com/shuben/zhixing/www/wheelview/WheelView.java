...
import com.shuben.zhixing.www.wheelview.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	//*/
	private int[] SHADOWS_COLORS = new int[] { 0xefE3E3E3, 0xcfE3E3E3, 0x3fE3E3E3 };
	...
	private void initResourcesIfNecessary() {
		...
		if (topShadow == null) {
			topShadow = new GradientDrawable(Orientation.TOP_BOTTOM, null);
		}

		if (bottomShadow == null) {
			bottomShadow = new GradientDrawable(Orientation.BOTTOM_TOP, null);
		}
	...
	private int getDesiredHeight(LinearLayout layout) {
		...
		Log.e("Text","oooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo"+desired);
	...
	private int getItemHeight() {
		...
		if (itemsLayout != null && itemsLayout.getChildAt(0) != null) {
			...
			Log.e("Text","oooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo2222"+itemHeight);
			return itemHeight;
		}

		return getHeight() * 5/visibleItems;
	}

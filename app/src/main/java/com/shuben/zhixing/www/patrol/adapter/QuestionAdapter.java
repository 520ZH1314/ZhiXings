...
public class QuestionAdapter  extends BaseAdapter {
    ...
    private  String type="";
    public QuestionAdapter(Activity mContext, List<MyQuseInfo> data,String type) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
       ...
       myQuseInfo=data.get(position);
        ...
        holder.bnt_start.setOnClickListener(new QuestionAdapter.lvButtonListener(position));
    ...
    class lvButtonListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if ((v.getId()) == (holder.bnt_start.getId())) {
                ...
                intent.putExtra("Status",data.get(position).getItem12());

 ...
 *
 */
public class ViewPagerIndicator01 extends LinearLayout
{
	/**
	 * 绘制三角形的画笔
	 */
	...
	public ViewPagerIndicator01(Context context)
	{
		this(context, null);
	}

	public ViewPagerIndicator01(Context context, AttributeSet attrs)
	{
		super(context, attrs);

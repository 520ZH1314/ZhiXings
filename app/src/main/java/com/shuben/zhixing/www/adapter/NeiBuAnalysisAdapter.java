 ...
 * 新通知适配数据
 */
public  class NeiBuAnalysisAdapter extends BaseAdapter {
    private Context mContext;
    private List<GetCustomerAnalysis_Data> datas;
    private LayoutInflater inflater;
    public NeiBuAnalysisAdapter(Activity activity, List<GetCustomerAnalysis_Data> news) {
        datas = news;
        mContext =activity;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.analysis_item_number.setText(datas.get(position).getCustomerName());//姓名

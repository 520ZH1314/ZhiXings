...
/**
 * Created by Geyan on 2018/4/23.
 */

public class MyQuseInfo implements Serializable {
    private String item01;//问题记录ID
    private String item02;//巡线任务记录ID
    private String item03;//问题描述
    private String item04;//严重程度
    private float item05;//责任部门ID
    private String item06;//责任部门名称
    private String item07;//责任人ID
    private String item08;//责任人姓名
    private String item09;//责任部门ID
    private String item10;//问题状态
    private String item11;//问题状态
    private String item12;//问题状态

    public MyQuseInfo(String item01, String item02, String item03, String item04, float item05, String item06, String item07, String item08, String item09, String item10, String item11, String item12) {
        this.item01 = item01;
        this.item02 = item02;
        this.item03 = item03;
        this.item04 = item04;
    ...
    public float getItem05() {
        return item05;
    }

    public void setItem05(float item05) {
        this.item05 = item05;
    }

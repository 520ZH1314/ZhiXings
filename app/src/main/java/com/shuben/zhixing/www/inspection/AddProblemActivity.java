    ...
    private void initView() {
        ...
        gridview_photo.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                PhotoPreview.init().setPhotoPaths(imagePaths).setCurrentPos(position).setPreviewOnly(true).startPreview(AddProblemActivity.this, null);
...
*/
    ...
    private void commit() {
        ...
        params.put("ItemSource", getIntent().getStringExtra("ItemSource"));
        params.put("CreateUserCode", SharedPreferencesTool.getMStool(AddProblemActivity.this).getUserCode());
        ...
        try {
            ...
            data.put("TenantId", SharedPreferencesTool.getMStool(AddProblemActivity.this).getTenantId());
            data.put("ProblemId", "");
            ...
            data.put("ItemId", getIntent().getStringExtra("ItemId"));
            data.put("ItemSource", getIntent().getStringExtra("ItemSource"));
            data.put("CreateUserCode", SharedPreferencesTool.getMStool(AddProblemActivity.this).getUserCode());


        } catch (JSONException e) {
            e.printStackTrace();
        }
        Log.e("******问题提交*****",data.toString());
            ...
            public void onResponse(JSONObject jsonobj) {
                ...
                try {
                    ...
                    if(status.equals("true")){
                        Toast.makeText(AddProblemActivity.this,"提交问题成功",Toast.LENGTH_SHORT).show();
                        if(imagePaths.size()>0){

...
public class MyRatingBar extends View {
    ...
    private void drawBackgroundStars(Canvas canvas) {
        Bitmap bitmap=((BitmapDrawable)getResources().getDrawable(R.drawable.star_gray)).getBitmap();
    ...
    private void drawStars(Canvas canvas) {
        Bitmap bitmap=((BitmapDrawable)getResources().getDrawable(R.drawable.star_yellow)).getBitmap();

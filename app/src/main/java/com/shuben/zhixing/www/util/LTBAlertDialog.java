...
public class LTBAlertDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dialog_alert_content);
        initView();
        initData();
     ...
     * @return
     */
    public static LTBAlertDialog getLtbAlertDialog(Context context, boolean cancelable, boolean canceledOnTouchOutside) {
     ...
     */
    public LTBAlertDialog setOnPositiveClickListener(String character, View.OnClickListener onPositiveClickListener) {
     ...
     */
    public LTBAlertDialog setOnNegativeClickListener(String character, View.OnClickListener onNegativeClickListener) {
     ...
     * @param title
     */
    public LTBAlertDialog setTitle(String title) {
        this.title = title;
        return ltbAlertDialog;
    }
     ...
     * @param message
     */
    public LTBAlertDialog setMessage(String message) {
     ...
     * @param viewContainer
     */
    public LTBAlertDialog setViewContainer(View viewContainer) {

...
import com.shuben.zhixing.www.reminder.r_fragment.CreateReminderssFragment;
import com.shuben.zhixing.www.reminder.r_fragment.MyTaskFragment;
...
//内部催单
public class ReminderActivity extends BaseActvity implements View.OnClickListener {
    ...
    private void initFragments(){
        ...
        fragments[0] = new CreateReminderssFragment();
        fragments[1] = new MyTaskFragment();
        fragments[2] = new StatisticsFragment(1);
        fragments[3] = new QueryFragment(1);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            if (isExit == 0) {
                Log.e("Text","2222222222222");

                //Toast.makeText(ReminderActivity.this, "再点一下退出", Toast.LENGTH_SHORT).show();

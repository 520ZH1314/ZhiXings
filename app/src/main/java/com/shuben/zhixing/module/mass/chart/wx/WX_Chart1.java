 ...
 * 不良原因和
 */
public class WX_Chart1 extends BaseActvity {
    ...
    public void process(Message msg) {
            switch (msg.what){
                case 0:
                    ...
                    ShowMassPie pie = new ShowMassPie(WX_Chart1.this,si,"0","1",startTime,endTime,type);
                ...
                case 1:
                    ...
                    if(situationArrt.size()!=0){
                        combineChartManager = new CombinedChartManager(WX_Chart1.this,getHandler(),mChart);
    ...
    public void initLayout() {
        ...
        select_time.setOnClickListener(view -> {
            ChangeDoubleTime doubleTime = new ChangeDoubleTime(WX_Chart1.this);
...
//        lineNames.add("折线图四");
        ...
        tetle_tv_ok.setOnClickListener( v->  loadData());
...
//        loadData();
    ...
    private  void loadData(){
        ...
        params.put("TenantId",SharedPreferencesTool.getMStool(WX_Chart1.this).getTenantId());
//        params.put("TenantId",SharedPreferencesTool.getMStool(context).getTenantId());
        httpPostVolley(SharedPreferencesTool.getMStool(WX_Chart1.this).getIp() + UrlUtil.Url, params, new VolleyResult() {
            @Override
            public void success(JSONObject jsonObject) {
                ...
                try {
                    ...
                    for(int i=0;i<len;i++){
                       ...
                       String key =  o.getString("RepairContent");

 ...
 * 不良原因和
 */
public class WX_Chart3 extends BaseActvity {
    ...
    public void process(Message msg) {
            switch (msg.what){
                case 0:
                    ...
                    ShowMassPie pie = new ShowMassPie(WX_Chart3.this,si,"0","1",startTime,endTime,type);
                ...
                case 1:
                    ...
                    if(situationArrt.size()!=0){
                        combineChartManager = new CombinedChartManager(WX_Chart3.this,getHandler(),mChart);
    ...
    public void initLayout() {
        ...
        select_time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ChangeDoubleTime doubleTime = new ChangeDoubleTime(WX_Chart3.this);
    ...
    private void parse(JSONObject jsonObject){
        ...
        try {
            ...
            for(int i=0;i<len;i++){
                ...
                String key = null;
                if(INDEX==5){
                    key =  o.getString("ExceptionName");
                }else if(INDEX==6){
                    key =  o.getString("RepairName");
                }
...
//                    int sel = 1;
    ...
    private  void loadData(){
        ...
        params.put("picNO","");
        if(INDEX==5){
            params.put("ExceptionName",edit.getTextEx().intern());//不良现象
            params.put("RepairName","");//不良原因
        }else if(INDEX==6){
            params.put("ExceptionName","");//不良现象
            params.put("RepairName",edit.getTextEx().intern());//不良原因
        }

        params.put("RapairDate","");
        params.put("beginDate",startTime);
        params.put("endDate",endTime);
        params.put("TenantId",SharedPreferencesTool.getMStool(WX_Chart3.this).getTenantId());

...
public class SelectEventActivity extends BaseActvity {
    ...
    private GradingEventViewModel gradingEventViewModel;
    ...
    private void initData() {
        mList=new ArrayList<>();
        gradingEventViewModel.getEventDatas().observe(this, new Observer<List<GradingEventEntity>>() {
            @Override
            public void onChanged(@Nullable List<GradingEventEntity> gradingEventEntities) {

                if (gradingEventEntities!=null){
                    mList.addAll(gradingEventEntities);
                    gradingEventAdapt = new GradingEventAdapt(R.layout.item_grading_event, gradingEventEntities);
    ...
    private void initView() {
         gradingEventViewModel = ViewModelProviders.of(this).get(GradingEventViewModel.class);
    ...
    public void onViewClicked(View view) {
        ...
        if (i == R.id.iv_work_add_work) {
            ...
            EventBus.getDefault().post(new GradingEventBean(gradingEventAdapt.getSelectedPosData().name,gradingEventAdapt.getSelectedPosData().score));

...
public class CustomDialog extends DialogFragment {
    ...
    public static CustomDialog newInstance(String titile,String titileDesc,String btn1,String btn2) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view= LayoutInflater.from(getActivity()).inflate(R.layout.performance_custom_dialog, null);

        mTvTitle=(TextView)view.findViewById(R.id.tv_performance_custom_title);
        mTvTitleDesc=(TextView) view.findViewById(R.id.tv_performance_custom_title_desc);
        ...
        mTvTitleDesc.setText(titileDesc);
        mDiss.setText(btn1);

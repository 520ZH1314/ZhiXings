...
public class Animation {
    ...
    public void start(final AnimationTextView textView) {
        ...
        final Runnable animate = new Runnable() {
            ...
            public void run() {
                ...
                maskYAnimator.setRepeatMode(ValueAnimator.RESTART);
        ...
        if (!textView.isSetUp()) {
            textView.setAnimationSetupCallback(new AnimationTextView.AnimationSetupCallback() {
                @Override
                public void onSetupAnimation(final AnimationTextView target) {
                    animate.run();
                }
            });
        } else {

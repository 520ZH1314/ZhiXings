 ...
 * 添加质量管理
 */
public class AddMassActivity3_ extends BaseActvity {
    @Override
    ...
    public void initLayout() {
        ...
        tetle_text.setText("添加添加维修单");
        scan_view = findViewById(R.id.scan_view);
        scan_view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(AddMassActivity3_.this,ScanMassActivity.class);
        ...
        sure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    if(edit.getTextEx().length()==0){
                        Toasty.INSTANCE.showToast(AddMassActivity3_.this,"请输入工单号");
                        return;
                    }

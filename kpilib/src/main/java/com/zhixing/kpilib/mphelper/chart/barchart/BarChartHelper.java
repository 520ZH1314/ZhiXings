package com.zhixing.kpilib.mphelper.chart.barchart;
...
public class BarChartHelper {
    ...
    private BarChartHelper(Builder builder) {
        ...
        this.menusListBean = builder.menusListBean;
        this.i = builder.i;
        initLineChart();
    }
    ...
    private void initLineChart() {
        ...
        legend.setTextSize(TypedValue.COMPLEX_UNIT_SP,legendTextSize);
        //显示位置
    ...
    private void setData(List<IBarData> barChartData) {
        ...
        LimitLine limitLine = new LimitLine(menusListBean.get(i).getTargetValue(), "期望"); //得到限制线
        ...
        description.setText(DataFormat(menusListBean.get(i).getCycleCode()));
        ...
        BarDataSet barDataSet = new BarDataSet(entries, menusListBean.get(i).getTypeName()+":"+"单位"+"("+menusListBean.get(i).getUnit()+")");
    ...
    public static class Builder {
        ...
        public Builder setBaseData(List<MenuEntity.RowsBean> menusListBean, int i) {
            this.menusListBean = menusListBean;
            this.i = i;
            return this;
        }
    }

 ...
 */
public class MeetListActivity extends BaseActvity implements View.OnClickListener {
    ...
    public void DialogEvent(MeetStatusType meetStatusType){
        mTvMeetStatusType.setText(meetStatusType.getName());
    }

    @Override
    public void onClick(View v) {
        if (v.getId()==R.id.rl_meet_type){
            MeetStatusTypeDialog dialog=new MeetStatusTypeDialog();

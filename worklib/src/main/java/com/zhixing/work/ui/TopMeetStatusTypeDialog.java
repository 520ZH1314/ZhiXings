 ...
 */
public class TopMeetStatusTypeDialog extends DialogFragment {
    ...
    public static TopMeetStatusTypeDialog newInstance(String jsonString) {
        TopMeetStatusTypeDialog fragment = new TopMeetStatusTypeDialog();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        adapter=new MeetStatusListAdapter(R.layout.item_recy_top_dialog_meet_status,datas);
    ...
    public void onStart() {
        ...
        windowParams.width=dm.widthPixels*1;

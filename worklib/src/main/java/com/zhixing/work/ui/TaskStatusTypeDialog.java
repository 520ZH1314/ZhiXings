 ...
 */
public class TaskStatusTypeDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        data.add(new MeetStatusType("未完成的"));
        data.add(new MeetStatusType("已完成的"));
        data.add(new MeetStatusType("我发出的"));
        data.add(new MeetStatusType("我执行的"));
        data.add(new MeetStatusType("抄送我的"));

...
public class LabelView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        this.topPadding = ta.getDimension(R.styleable.LabelView_labelTopPadding, dp2px(7));
        this.centerPadding = ta.getDimension(R.styleable.LabelView_labelCenterPadding, dp2px(3));
        this.bottomPadding = ta.getDimension(R.styleable.LabelView_labelBottomPadding, dp2px(3));

        this.backGroundColor = ta.getColor(R.styleable.LabelView_backgroundColor, Color.parseColor("#66000000"));
        this.primary.color = ta.getColor(R.styleable.LabelView_primaryTextColor, Color.WHITE);
        this.secondary.color = ta.getColor(R.styleable.LabelView_secondaryTextColor, Color.WHITE);

        this.primary.size = ta.getDimension(R.styleable.LabelView_primaryTextSize, sp2px(11));
        this.secondary.size = ta.getDimension(R.styleable.LabelView_secondaryTextSize, sp2px(8));

        final String primary = ta.getString(R.styleable.LabelView_primaryText);
        if (primary != null) {
            this.primary.text = primary;
        }
        final String secondary = ta.getString(R.styleable.LabelView_secondaryText);
        if (secondary != null) {
            this.secondary.text = secondary;
        }

        this.primary.style = ta.getInt(R.styleable.LabelView_primaryTextStyle, 2);
        this.secondary.style = ta.getInt(R.styleable.LabelView_secondaryTextStyle, 0);

        this.corner = Corner.from(ta.getInt(R.styleable.LabelView_corner, 1));

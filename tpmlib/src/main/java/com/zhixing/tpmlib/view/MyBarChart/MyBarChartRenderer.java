package com.zhixing.tpmlib.view.MyBarChart;
    ...
    protected void drawDataSet(Canvas c, IBarDataSet dataSet, int index) {
        ...
        if (mChart.isDrawBarShadowEnabled()) {
            ...
            for (int i = 0, count = Math.min((int)(Math.ceil((float)(dataSet.getEntryCount()) * phaseX)), dataSet.getEntryCount());
                ...
                RectF rectF=new RectF(mBarShadowRectBuffer);
                float[] radii={50f,50f,50f,50f,0f,0f,0f,0f};
...
//                c.drawRect(mBarShadowRectBuffer, mShadowPaint);
        ...
        if (isSingleColor){
            LinearGradient backGradient = new LinearGradient(0, 0, 0,  buffer.buffer[4 + 3], new int[]{Color.parseColor("#cb85f3"), Color.parseColor("#7a69f1")}, null, Shader.TileMode.CLAMP);
            mRenderPaint.setShader(backGradient);
        }
        ...
        for (int j = 0; j < buffer.size(); j += 4) {
            ...
            if (color==Color.parseColor("#2297f3")){
                LinearGradient backGradient1 = new LinearGradient(0, 0, 0,  buffer.buffer[7], new int[]{Color.parseColor("#5ac7ed"), Color.parseColor("#2297f3")}, null, Shader.TileMode.CLAMP);
                mRenderPaint.setShader(backGradient1);

            }else if (color==Color.parseColor("#2271f3")){
                LinearGradient backGradient2 = new LinearGradient(0, 0, 0,  buffer.buffer[7], new int[]{Color.parseColor("#628cfe"), Color.parseColor("#2271f3")}, null, Shader.TileMode.CLAMP);
                mRenderPaint.setShader(backGradient2);
            ...
            if (drawBorder) {
                ...
                c.drawRoundRect(buffer.buffer[j], buffer.buffer[j + 1], buffer.buffer[j + 2],
                        buffer.buffer[j + 3],100,100,mBarBorderPaint);
